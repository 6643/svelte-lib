...
<button type="button" aria-label={theme.value === "dark" ? "切换浅色模式" : "切换深色模式"} onclick={toggleTheme}>
    <SvgIcon svgPaths={iconFor(theme.value)} />
</button>
...
<style>
    button {
        ...
        color: var(--accent-color, var(--raised-fg));
    }
